-- SQL exploratory data analysis project using a "Pizza Sales" dataset to demonstrate knowledge of syntax to provide business insights for a fictional pizzeria.
